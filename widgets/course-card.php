    ...
    protected function render() {
        ...
        <div class="etlms-course-list-col">
            ...
            <div class="tutor-course-thumbnail">
                <a
                href="<?php echo esc_attr( $settings['course-lp-url']['url'] ); ?>"
                class="tutor-d-block" >
                <div class="tutor-ratio tutor-ratio-16x9">
                    <img
                    decoding="async"
                    class="tutor-card-image-top"
                    src="<?php echo esc_attr( $settings['course-image']['url'] ); ?>"
                    alt="<?php echo esc_attr( $settings['course-title'] ); ?> fotografija tečaja"
                    loading="lazy"
                    />
                </div>
                </a>
